  ...
  return (
    <section ref={sectionRef} id="achievements" className="section-padding bg-gray-50 dark:bg-transparent relative overflow-hidden transition-colors duration-300">
      ...
      <div className="container relative z-20">
        <h2 ref={titleRef} className="text-5xl xs:text-6xl sm:text-6xl md:text-7xl font-display text-center mb-16 gradient-text-gold leading-tight py-2" style={{ opacity: 0 }}>
          Awards & Recognition
        </h2>
