...
const Achievements: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="achievements" className="section-padding bg-gray-50 dark:bg-transparent relative overflow-hidden transition-colors duration-300 scroll-mt-28">
