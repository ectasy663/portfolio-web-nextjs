...
export const skillCategories = [
  {
    ...
    skills: [
      { name: "LangChain & Frameworks", icon: React.createElement(FaProjectDiagram, { className: "text-2xl text-blue-500", "aria-hidden": "true" }), level: 90 },
      { name: "LLM Orchestration", icon: React.createElement(FaNetworkWired, { className: "text-2xl text-purple-400", "aria-hidden": "true" }), level: 95 },
      { name: "RAG Pipelines", icon: React.createElement(FaDatabase, { className: "text-2xl text-emerald-400", "aria-hidden": "true" }), level: 92 },
      { name: "Autonomous Agents", icon: React.createElement(FaRobot, { className: "text-2xl text-pink-400", "aria-hidden": "true" }), level: 88 },
      { name: "Prompt Engineering", icon: React.createElement(FaCode, { className: "text-2xl text-yellow-400", "aria-hidden": "true" }), level: 95 },
  ...
  },
  {
    ...
    skills: [
      { name: "TensorFlow", icon: React.createElement(SiTensorflow, { className: "text-2xl text-orange-500", "aria-hidden": "true" }), level: 85 },
      { name: "PyTorch", icon: React.createElement(SiPytorch, { className: "text-2xl text-red-500", "aria-hidden": "true" }), level: 80 },
      { name: "NumPy", icon: React.createElement(SiNumpy, { className: "text-2xl text-blue-400", "aria-hidden": "true" }), level: 90 },
      { name: "Pandas", icon: React.createElement(SiPandas, { className: "text-2xl text-purple-400", "aria-hidden": "true" }), level: 92 },
      { name: "Jupyter", icon: React.createElement(SiJupyter, { className: "text-2xl text-orange-400", "aria-hidden": "true" }), level: 88 },
      { name: "Predictive Modeling", icon: React.createElement(FaChartBar, { className: "text-2xl text-pink-400", "aria-hidden": "true" }), level: 85 },
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Tailwind CSS", icon: React.createElement(SiTailwindcss, { className: "text-2xl text-teal-400", "aria-hidden": "true" }), level: 92 },
      { name: "JavaScript", icon: React.createElement(SiJavascript, { className: "text-2xl text-yellow-400", "aria-hidden": "true" }), level: 95 },
    ],
  ...
  },
  {
    ...
    skills: [
      { name: "Node.js", icon: React.createElement(SiNodedotjs, { className: "text-2xl text-green-500", "aria-hidden": "true" }), level: 88 },
      { name: "PostgreSQL", icon: React.createElement(SiPostgresql, { className: "text-2xl text-blue-400", "aria-hidden": "true" }), level: 85 },
      { name: "Supabase", icon: React.createElement(SiSupabase, { className: "text-2xl text-emerald-400", "aria-hidden": "true" }), level: 85 },
